...
export const filters: Filter[] = [
  { id: 'video', label: 'Video & Live', value: '1000+ videos produced' },
  { id: 'web', label: 'Digital Marketing', value: '10M+ social reach' },
  { id: 'webdesign', label: 'Web Design', value: 'Modern web experiences' },
  { id: 'ai', label: 'AI & Automation', value: '15+ AI solutions' },
  { id: 'all', label: 'All Projects', value: '8+ years of digital innovation' }
];
